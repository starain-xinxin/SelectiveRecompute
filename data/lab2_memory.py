...
# 创建数据
non_data = np.array([27.4368,
55.553,
70.48]) / 80 * 100
attn_data = np.array([7.916,
12.1,
18.27648,
25.18,
35.564,
47]) / 80 * 100
select_data = np.array([27.435,
55.542,
67.633,
75.15,
67.264,
...
sns.barplot(x='模型参数量', y='显存效率', hue='重计算方法', data=df, palette='pastel')
